...
local function main()
	...
	Class = jni.wrapClass("Class.ini")
	Field = jni.wrapClass("Field.ini")
	Method = jni.wrapClass("Method.ini")
	Constructor = jni.wrapClass("Constructor.ini")
	Modifier = jni.wrapClass("Modifier.ini")
